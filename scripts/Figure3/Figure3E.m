...
% Load data
datapath = 'datapath'; 
Elbow=  readtable(fullfile(datapath, 'Figure3E_ElbowExtension.csv')); 
Wrist=  readtable(fullfile(datapath, 'Figure3E_WristFlexion.csv')); 
...
subplot(1, 2, 2)
frequencies = Wrist.Properties.VariableNames'; 
hold on
for iF = 2 : nFreq
    datapoints = Wrist.(frequencies{iF}); 
