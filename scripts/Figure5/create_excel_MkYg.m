clear all
close all
Ygritte_fig = '/Users/Bea/Dropbox/CERVICAL SCS PAPER/NATURE NEURO/REVIEW-ROUND2/Figure5/Mk_Yg_EMG_allmuscles.fig';
...
dates_idx = [ 2 3 5];
baseline_plot_idx = [ 3.5, 5.5, 9.5]; 
stim_plot_idx = [4.5, 6.5, 10.5]; 
