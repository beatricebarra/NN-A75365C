...
stimMask = {
    ...
    [0 0 0 1 1 1 3 3 1 1 1 1 1 1 1 1 ];
}% each cell is a date, 1 means stim file, 0 is basel



timefile = xlsread('/Users/barrab01/Dropbox/CERVICAL SCS PAPER/NATURE NEURO/REVIEW-ROUND2/Events_data/ActiveTimesMkYg.xlsx'); 
...
events_file = xlsread('/Users/barrab01/Dropbox/CERVICAL SCS PAPER/NATURE NEURO/REVIEW-ROUND2/Events_data/MkYg_events.xlsx'); 
...
% Phasic vs tonic
[p] = manual_pvalue( mean_grasp_S(i),mean_grasp_T(i), std_grasp_S(i), std_grasp_T(i) )
if p <= 0.05
