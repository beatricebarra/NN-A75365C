ygritte_fig = '/Users/Bea/Dropbox/CERVICAL SCS PAPER/NATURE NEURO/REVIEW-ROUND2/Figure4/final/MkYg_rates.fig';

fig = openfig(ygritte_fig);
fig = gcf;
...
%% Grasp
dataObjs = graspAx.Children
for i = length(dataObjs) : -1 : 3
...
mytable(6, 4:7) = num2cell(60*mean_bas); 
mytable(7, 4:7) = num2cell(60*std_bas); 
mytable(8, 4:7) = num2cell(60*mean_stim); 
mytable(9, 4:7) = num2cell(60*std_stim); 

%% Grasp
dataObjs = pullAx.Children
for i = length(dataObjs) : -1 : 2
...
mytable(10, 4:7) = num2cell(60*mean_bas); 
mytable(11, 4:7) = num2cell(60*std_bas); 
mytable(12, 4:7) = num2cell(60*mean_stim); 
mytable(13, 4:7) = num2cell(60*std_stim); 

filename = '/Users/Bea/Dropbox/CERVICAL SCS PAPER/NATURE NEURO/REVIEW-ROUND2/RawDataSheets/Figure4C.xlsx';
writecell(mytable,filename,'Sheet','Ygritte')
